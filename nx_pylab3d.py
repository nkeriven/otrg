"""
Modification of Networkx nx_pylab.py to handle 3d positions.
"""
...
__all__ = [
    "draw3d",
    "draw_networkx3d",
    "draw_networkx_nodes3d",
    "draw_networkx_edges3d",
    "draw_networkx_labels3d",
...
def draw3d(G, pos=None, ax=None, fig=None, display_axis=False, **kwds):
    ...
    #     else:
    #         ax = cf.gca(projection='3d')

    if "with_labels" not in kwds:
        kwds["with_labels"] = "labels" in kwds

    draw_networkx3d(G, pos=pos, ax=ax, **kwds)
    if not display_axis:
        ax.set_axis_off()
...
def draw_networkx3d(G, pos=None, arrows=True, with_labels=True, **kwds):
    ...
    if pos is None:
        ...
        pos = {i:list(pos[i])+[0] for i in G.nodes}

    draw_networkx_edges3d(G, pos, arrows=arrows, **edge_kwds)
    draw_networkx_nodes3d(G, pos, **node_kwds)
    if with_labels:
        draw_networkx_labels3d(G, pos, **label_kwds)
    plt.draw_if_interactive()


def draw_networkx_nodes3d(
    G,
    pos,
    nodelist=None,
    node_size=300,
...
def draw_networkx_edges3d(
    ...
    if G.is_directed() and arrows:
        ...
        arrow_colors = colorConverter.to_rgba_array(edge_color, alpha_edge)
...
def draw_circular(G, **kwargs):
    ...
    kwargs : optional keywords
       ...
       function.
    """
    draw3d(G, circular_layout(G), **kwargs)
...
def draw_kamada_kawai(G, **kwargs):
    ...
    kwargs : optional keywords
       ...
       function.
    """
    draw3d(G, kamada_kawai_layout(G), **kwargs)
...
def draw_random(G, **kwargs):
    ...
    kwargs : optional keywords
       ...
       function.
    """
    draw3d(G, random_layout(G), **kwargs)
...
def draw_spectral(G, **kwargs):
    ...
    kwargs : optional keywords
       ...
       function.
    """
    draw3d(G, spectral_layout(G), **kwargs)
...
def draw_spring(G, **kwargs):
    ...
    kwargs : optional keywords
       ...
       function.
    """
    draw3d(G, spring_layout(G), **kwargs)
...
def draw_shell(G, **kwargs):
    ...
    if nlist is not None:
        del kwargs["nlist"]
    draw3d(G, shell_layout(G, nlist=nlist), **kwargs)
...
def draw_planar(G, **kwargs):
    ...
    kwargs : optional keywords
       ...
       function.
    """
    draw3d(G, planar_layout(G), **kwargs)
